const translations = {
	ja: {
		...
		field: "専門分野: 数理最適化，非線形最適化理論の均衡問題への応用（ナッシュ均衡問題，ロバスト均衡問題）",
		news: "ニュース",
		publications: "研究業績",
		"under-review": "投稿中",
		presentations: "発表実績",
		...
		award: "表彰歴",
		contact: "連絡先",
		email: "メール: hori.atsushi [*] nitech.ac.jp",
		diary: "ショートブログ",
		"menu-toc": "目次",
		"menu-profile": "プロフィール",
		"menu-news": "ニュース",
	...
	en: {
		...
		affiliation: "Affiliation: Graduate School of Engineering, Nagoya Institute of Technology (from April 1st, 2025)",
		field: "Field: Mathematical Optimization, Application of nonlinear optimization theory into equilibrium problems (e.g., Nash equilibrium problem, robust equilibrium problem)",
		news: "News",
		...
		jima: "Japan Industrial Management Association (JIMA)",
		jsiam: "The Japan Society for Industrial and Applied Mathematics (JSIAM)",
		siam: "SIAM (Society for Industrial and Applied Mathematics)",
		mos: "Mathematical Optimization Society",
		committee: "Committee Activities",
		award: "Awards",
		contact: "Contact",
		email: "Email: hori.atsushi [*] nitech.ac.jp",
