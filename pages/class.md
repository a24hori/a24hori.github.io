...
<dl class="qa-list">
  ...
  このような複数の意思決定者が互いに他者の戦略を予測しながら最適化問題を解く状況において，同時に最適解を求めるような問題は均衡問題の代表例です（ナッシュ均衡問題）．
  ある意味で，均衡問題は最適化問題を含む一般的なクラスの問題のみなすこともできます．
  均衡問題を数学的に定式化したものが変分不等式問題や相補性問題です．
